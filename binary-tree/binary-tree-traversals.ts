...
function preOrderIterative(root: TreeNode, visit: (node: TreeNode) => void): void {
...
function preOrderRecursive(root: TreeNode, visit: (node: TreeNode) => void): void {
    if (!root) return
...
function inOrderRecursive(root: TreeNode, visit: (node: TreeNode) => void): void {
    if (!root) return
...
function inOrderIterative(root: TreeNode, visit: (node: TreeNode) => void): void {
    let node = root
    const stack = new Stack<TreeNode>()
...
function postOrderRecursive(root: TreeNode, visit: (node: TreeNode) => void): void {
    if (!root) return
...
function postOrderIterative(root: TreeNode, visit: (node: TreeNode) => void): void {
    let node = root
    const stack = new Stack<TreeNode>()
